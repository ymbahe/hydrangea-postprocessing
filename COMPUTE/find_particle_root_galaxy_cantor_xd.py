...
host_mass_nbins = 3     # incl. 2 for outliers
...
def load_particles():
    ...
    for iiptype in ptypeList:
        ...
        all_ft = np.concatenate((all_ft, ptype_ft[ptype_in_gal]))
