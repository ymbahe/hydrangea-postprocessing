...
outloc = '/freya/ptmp/mpa/ybahe/HYDRANGEA/RESULTS/GalaxyEvolCatalogue9p0_Hydrangea_' + datestamp + '_HYDRO.hdf5'
...
if simname == "Eagle":
    basedir_hl = '/freya/ptmp/mpa/ybahe/EAGLE/'
    snapAexpLoc = '/freya/ptmp/mpa/ybahe/HYDRANGEA/OutputLists/eagle_outputs_new.txt'
    nsnap = 29
    n_sim = 6
    boxvec = ['L0025N0376', 'L0025N0752', 'L0025N0752', 'L0050N0752', 'L0050N0752', 'L0100N1504']
    modelvec = ['REFERENCE', 'REFERENCE', 'RECALIBRATED', 'REFERENCE', 'S15_AGNdT9', 'REFERENCE']
    resvec = [0, 1, 1, 0, 0, 0]
...
for isim in range(n_sim):
    ...
    if simname == 'Hydrangea':
        hldir = basedir + 'CE-' + str(isim) + '/' + simtype + '/highlev/'
    else:
        hldir = basedir_hl + boxvec[isim] + '/' + modelvec[isim] + '/highlev/'  
    ...
    if simname == 'Hydrangea': 
        ...
        if (isim in [17, 19, 20, 23, 26, 27]) and (include_ceo is false): continue

    else:
        print("")
        print("=============================")
        print("Processing simulation EAGLE-" + boxvec[isim] + '/'+ modelvec[isim])
        print("=============================")
        print("", flush = True)
